    ...
    public class AICommands : CommandModule
    {
        ...
        public void SpawnFromProfile(string id)
        {
            ...
            try
            {
                ...
                var maxDistance = profile.RequiredPlayerDistance + 1000;
        ...
        [Command("teleport", "Teleports the last spawned NPC to your position")]
        [Permission(MyPromoteLevel.Admin)]
        public void TeleportNpc()
        {
            ...
            if (grid == null)
            {
                Context.Respond("NPC grid not found.");
                return;
            }
            grid.SetPosition(player.GetPosition() + player.Character.WorldMatrix.Forward * 10);
            Context.Respond($"Teleported NPC '{npc.Grid.DisplayName}' to your location.");
        }
    }
}