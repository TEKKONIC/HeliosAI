...
namespace Helios.Plugin.Logging
{
    public class PluginLogger : ILogger
    {
        ...
        public void Trace(string message, params object[] data) => logger.Trace(message, data);
        ...
        public void Debug(string message, params object[] data) => logger.Debug(message, data);
        ...
        public void Info(string message, params object[] data) => logger.Info(message, data);
        ...
        public void Warning(string message, params object[] data) => logger.Warn(message, data);
        public void Error(string message)
        {
            throw new NotImplementedException();
        }

        public void Error(string message, params object[] data) => logger.Error(message, data);
        ...
        public void Critical(string message, params object[] data) => logger.Fatal(message, data);
        ...
        public void Trace(Exception ex, string message, params object[] data) => logger.Trace(ex, message, data);
        ...
        public void Debug(Exception ex, string message, params object[] data) => logger.Debug(ex, message, data);
        ...
        public void Info(Exception ex, string message, params object[] data) => logger.Info(ex, message, data);
        ...
        public void Warning(Exception ex, string message, params object[] data) => logger.Warn(ex, message, data);
        public void Error(Exception ex, string message, params object[] data) => logger.Error(ex, message, data);
        ...
        public void Critical(Exception ex, string message, params object[] data) => logger.Fatal(ex, message, data);
